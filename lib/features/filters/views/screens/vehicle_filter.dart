                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SelectItemsWidget<VehicleType>(
                      ...
                      selectedItems: controller.adVehicle.value.vehicleType!,
                    ),
                    const Space(),
                    SelectItemsWidget<AdCategory>(
                      ...
                      selectedItems: controller.adVehicle.value.adCategory!,
                    ),
                    const Space(),
                    DropdownButtonWidget(
                      onChanged: (v) {},
                    ...
                    FromToField(
                      ...
                      from: controller.adVehicle.value.vehicleWalkedByKilo!,
                      to: controller.adVehicle.value.vehicleWalkedByKiloTo!,
                    ),
                    const Space(),
                    FromToField(
                    ...
                    SelectItemsWidget<PaySystem>(
                      controller: controller.adVehicle.value.vehicleMadeYear!,
                      textFieldLabel:
                          controller.adVehicle.value.paySystem == PaySystem.cash
                              ? null
                      ...
                      selectedItems: [controller.adVehicle.value.paySystem!],
                    ),
                    const Space(),
                    SelectItemsWidget(
                      ...
                      selectedItems: [controller.adVehicle.value.currencyId],
                    ),
                  ],
                ),
              ),
