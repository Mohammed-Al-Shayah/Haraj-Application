...
class _RealEstateFilterState extends State<RealEstateFilter> {
  ...
  void initState() {
    controller =
        Get.put(FilterController(AdType.real_estates), tag: "real_estates");
              ...
              child: Column(
                ...
                children: [
                  ...
                  if ([
                    ...
                    SelectItemsWidget<int>(
                        ...
                        controller: controller
                            .adRealEstate.value.realEstateFloorsController,
                        onTextChanged: (v) {
                          controller.adRealEstate.update((val) {
                        ...
                        items: [
                          ...
                          3,
                          if (controller.adRealEstate.value.realEstateType ==
                              RealEstateType.buildings) ...[4, 5, 6]
                        ],
                        onChanged: (v) {
                          controller.adRealEstate.update((val) {
                  ...
                  if ([
                    ...
                    SelectItemsWidget<RealEstateFurnitureType>(
                        ...
                        selectedItems: controller
                            .adRealEstate.value.realEstateFurnitureType!),
                    const Space(),
                  ],
                  if (![
                    RealEstateType.buildings,
                    ...
                    SelectItemsWidget<int>(
                        ...
                        controller: controller
                            .adRealEstate.value.realEstateRoomsController,
                        onTextChanged: (v) {
                          controller.adRealEstate.update((val) {
                            int? value = int.tryParse(v!);
                            if (value == null) return;
                  ...
                  SelectItemsWidget<PaySystem>(
                      ...
                      textFieldLabel: controller.adRealEstate.value.paySystem ==
                              PaySystem.cash
                          ? null
                  ...
                  if (![
                    ...
                    SelectItemsWidget<int>(
                        textFieldLabel: "${AppStrings.more}: ",
                        controller: controller
                            .adRealEstate.value.realEstateBathsController,
                        onTextChanged: (v) {
                          controller.adRealEstate.update((val) {
                            int? value = int.tryParse(v!);
                            if (value == null) return;
                  ...
                  if (controller.adRealEstate.value.realEstateType ==
                    ...
                    SelectItemsWidget<int>(
                        textFieldLabel: "${AppStrings.more}: ",
                        controller: controller
                            .adRealEstate.value.realEstateGardensController,
                        onTextChanged: (v) {
                          controller.adRealEstate.update((val) {
                            int? value = int.tryParse(v!);
                            if (value == null) return;
                  ...
                  SelectItemsWidget(
                      ...
                      selectedItems: [
                        controller.adRealEstate.value.currencyId
                      ]),
                ],
              ),
            ),
