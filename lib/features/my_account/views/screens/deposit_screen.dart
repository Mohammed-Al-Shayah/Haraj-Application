...
class DepositScreen extends StatelessWidget {
  ...
  Widget _bankTransferDetails() {
    const accountNumber = '3453453435';
    final accounts = [
      AppStrings.bankAlAmqi,
      AppStrings.bankAlBusiri,
      AppStrings.bankAlKuraimi,
    ];

    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(AppStrings.bankTransferDetailsTitle, style: AppTypography.bold14),
        const SizedBox(height: 12),
        Container(
          width: double.infinity,
